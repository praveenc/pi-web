...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.themeCobaltzLight": "Cobalt Z 淺色",
    ...
    "theme.rose": "主題：薔薇",
    "theme.pine": "主題：松夜",
    "theme.cobaltz": "主題：Cobalt Z",
    "theme.cobaltz-light": "主題：Cobalt Z 淺色",
    "theme.auto": "主題：跟隨系統",
    "history.full": "完整紀錄",
    ...
    "chat.confirm": "確認",
    "chat.submit": "送出",
    "chat.questionnaireTitle": "代理程式有問題要問你",
    ...
    "chat.questionnaireReview": "檢查",
    "chat.questionnaireUnanswered": "未回答",
    "chat.questionnaireNoneSelected": "未選擇",
    "chat.questionnaireAnswerAll": "回答所有問題後才能送出",
