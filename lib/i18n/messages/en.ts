...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.themeCobaltzLight": "Cobalt Z Light",
    ...
    "theme.cobaltz": "Theme: Cobalt Z",
    "theme.cobaltz-light": "Theme: Cobalt Z Light",
    ...
    "chat.submit": "Submit",
    "chat.questionnaireTitle": "The agent has questions",
    "chat.questionnaireProgress": "{answered} of {total} answered",
    ...
    "chat.questionnaireUnanswered": "Not answered",
    "chat.questionnaireNoneSelected": "Nothing selected",
    "chat.questionnaireAnswerAll": "Answer every question to submit",
