...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.themeCobaltz": "Cobalt Z",
    "settings.themeCobaltzLight": "Cobalt Z 浅色",
    ...
    "theme.rose": "主题：蔷薇",
    "theme.pine": "主题：松夜",
    "theme.cobaltz": "主题：Cobalt Z",
    "theme.cobaltz-light": "主题：Cobalt Z 浅色",
    "theme.auto": "主题：跟随系统",
    "history.full": "完整历史",
    ...
    "chat.confirm": "确认",
    "chat.submit": "提交",
    "chat.questionnaireTitle": "智能体有问题要问你",
    "chat.questionnaireProgress": "已回答 {answered}/{total}",
    "chat.questionnaireTypeSomething": "自行输入。",
    "chat.questionnaireTypePlaceholder": "输入你的回答",
    "chat.questionnaireMultiHint": "可多选",
    "chat.questionnaireNumbersOnly": "仅含数字会被当作选项编号。请加上文字，或直接勾选选项。",
    "chat.questionnairePreview": "预览",
    "chat.questionnaireNext": "下一题",
    "chat.questionnaireBack": "上一题",
    "chat.questionnaireReview": "检查",
    "chat.questionnaireUnanswered": "未回答",
    "chat.questionnaireNoneSelected": "未选择",
    "chat.questionnaireAnswerAll": "回答所有问题后才能提交",
